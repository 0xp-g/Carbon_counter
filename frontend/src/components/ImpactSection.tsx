  ...
  return (
    <div className="box-border outline-[oklab(0.708_0_0_/_0.5)] py-20 md:py-32 min-h-screen flex items-center bg-white">
      <div className="box-border max-w-[1008px] outline-[oklab(0.708_0_0_/_0.5)] mx-auto px-3.5 md:px-[21px] w-full">
        ...
        <div className="items-start box-border gap-x-[21px] grid grid-cols-none outline-[oklab(0.708_0_0_/_0.5)] gap-y-[21px] md:gap-x-[42px] md:grid-cols-[repeat(3,minmax(0px,1fr))] md:gap-y-[42px]">
          {impactItems.map((item, index) => (
            <div 
              key={item.id} 
              className="group text-[oklch(0.145_0_0)] bg-white box-border flex flex-col p-7 rounded-[12.75px] transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg h-full"
            >
              <div className="box-border outline-[oklab(0.708_0_0_/_0.5)] text-left">
                <div className="items-center bg-black box-border flex h-14 justify-center outline-[oklab(0.708_0_0_/_0.5)] w-14 mb-[21px] rounded-full transition-colors duration-300">
                   {icons[index]}
                </div>
